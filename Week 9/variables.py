...
name = "Rob"
city ="London"
interests="Coding, Films, TV and Gaming"
...
username = "jsmsith" # use meaningful variable name
username1 = "paul125"
firstName = "Anna" # use camel notation:varaibles are case sensitive
firstname = "Jane" #  #not the same as varaible in line 40
last_name = "Wilson" # varaibles are case sensitive
last_Name = "Jameson" #not the same as varaible in line 42
userAge = 23
age = 24
...
# declare variable and assign value to them as shown num1 = 2
